...
public class ReadingDevice implements IReadingDevice {
    ...
    public ReadingDevice(String type, ArrayList<BaggageIdentificationTag> baggageIdentificationTagList){
        ...
        for (BaggageIdentificationTag baggageIdentificationTag : baggageIdentificationTagList) {
            boardingPassList.add(baggageIdentificationTag.getBoardingPass());
        }
    }
    ...
    public boolean scan(BoardingPass boardingPass){
        return boardingPassList.contains(boardingPass);
    }
}
